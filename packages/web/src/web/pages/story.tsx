...
export default function Story() {
  return (
    <Layout>
      <section className="pt-24 sm:pt-32 md:pt-48 pb-20 md:pb-32 px-4 sm:px-6 md:px-12 lg:px-24">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="space-y-8">
              <h1 className="font-display text-[clamp(2.5rem,10vw,6rem)] font-bold tracking-tighter uppercase leading-[0.8] text-glow break-words">
                Lokanin's <br /> Story
              </h1>
              <p className="font-sans text-xs md:text-sm tracking-[0.2em] uppercase text-muted-foreground border-l border-white/20 pl-4 sm:pl-6 py-2">
            ...
            <div className="max-w-2xl">
              <div className="space-y-6">
                ...
                <p className="font-serif text-xl sm:text-2xl md:text-3xl leading-tight">
                  "We want to make movies to get people to feel and get inspired."
                </p>
              </div>
            </div>

            <div className="space-y-14 sm:space-y-16 border-t border-white/5 pt-12 sm:pt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 sm:gap-12">
                <h3 className="font-sans text-[12px] tracking-[0.4em] uppercase text-muted-foreground">What we do</h3>
                <div className="space-y-6 sm:space-y-8 font-serif text-base sm:text-lg md:text-xl leading-relaxed text-foreground/90">
                  <p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 sm:gap-12">
                <h3 className="font-sans text-[12px] tracking-[0.4em] uppercase text-muted-foreground">Our FUTURE</h3>
                <div className="space-y-6 sm:space-y-8 font-serif text-base sm:text-lg md:text-xl leading-relaxed text-foreground/90">
                  <div className="space-y-3 text-foreground/90">
