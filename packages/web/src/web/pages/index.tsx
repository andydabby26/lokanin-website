  ...
  return (
    <Layout>
      <section className="relative min-h-[100svh] flex flex-col items-center justify-center px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative z-30 max-w-screen-2xl w-full text-center pt-20 sm:pt-0">
          <motion.div
          ...
          >
            <h1 
              className="font-display text-[clamp(2.6rem,14vw,12rem)] sm:text-[clamp(3rem,12vw,12rem)] font-bold tracking-tighter leading-[0.82] sm:leading-[0.8] uppercase break-words px-2"
        ...
        >
          <a href="#works" className="flex flex-col items-center gap-3 sm:gap-4 group cursor-pointer min-h-[48px]">
            <span className="font-sans text-[9px] sm:text-[10px] tracking-widest uppercase opacity-60">Scroll to explore</span>
            <div className="w-[1px] h-10 sm:h-12 bg-white/30 group-hover:h-16 sm:group-hover:h-20 transition-all duration-500" />
          </a>
        </motion.div>
      </section>

      <section id="works" className="py-20 sm:py-24 md:py-32 px-4 sm:px-6 md:px-24">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col gap-4 mb-10 sm:mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-start">
            ...
            <div className="space-y-8 sm:space-y-10 md:space-y-12 md:pt-4">
      ...
      <section className="py-20 sm:py-24 md:py-32 px-4 sm:px-6 border-t border-white/5 text-center">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
