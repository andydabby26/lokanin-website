...
export default function Contact() {
  return (
    <Layout>
      <section className="min-h-[100svh] flex items-center justify-center px-4 sm:px-6 py-24 sm:py-32">
        <div className="max-w-xl w-full text-center">
          ...
          >
            <span className="font-sans text-[10px] tracking-[0.4em] uppercase text-muted-foreground mb-10 sm:mb-12 block">
              Contact
            </span>

            <h2 className="font-display text-[clamp(2rem,8vw,4rem)] font-bold tracking-tighter uppercase mb-14 sm:mb-20 leading-[0.9] break-words">
            ...
            <div className="space-y-12 sm:space-y-16">
              <div className="space-y-8">
                ...
                <div className="space-y-2">
                  <a href="tel:+46704691414" className="font-sans text-base sm:text-lg tracking-tight hover:text-muted-foreground transition-colors min-h-[48px] flex items-center justify-center">
                    (+46) 704691414
                  </a>
              ...
              <div className="pt-12 sm:pt-16 border-t border-white/5">
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 md:gap-12">
