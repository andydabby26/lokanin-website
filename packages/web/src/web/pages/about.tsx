...
export default function About() {
  return (
    <Layout>
      {/* Desktop old layout */}
      <section className="hidden md:block pt-32 md:pt-48 pb-20 md:pb-32 px-6 md:px-12 lg:px-24">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[180px_1fr_240px] gap-16 md:gap-12 lg:gap-24">
                    ...
                    <div className="space-y-8">
                      ...
                      {[
                        ...
                        <div key={i} className="grid grid-cols-[1fr_auto] gap-4">
                          <div className="space-y-1"><h4 className="font-sans text-sm font-bold uppercase tracking-wider">{item.title}</h4><p className="text-[10px] text-muted-foreground uppercase tracking-widest">{item.role}</p></div>
                          <div className="text-right"><span className="text-[10px] tracking-widest text-muted-foreground uppercase">{item.year}</span><p className="text-[10px] text-muted-foreground/40 uppercase tracking-widest mt-1">{item.type}</p></div>
                        </div>
                      ))}
                    </div>
              ...
              <div className="space-y-8 order-3 md:col-span-2 lg:col-span-1">
                <div className="lg:sticky lg:top-32"><PhotoManager /></div>
              </div>
            </div>
          </motion.div>
        </div>
