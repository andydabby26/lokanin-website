    ...
    <Layout>
      <section className="pt-24 sm:pt-32 md:pt-48 pb-20 md:pb-32 px-4 sm:px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[180px_1fr_240px] gap-12 sm:gap-16 md:gap-12 lg:gap-24">
              ...
              <div className="space-y-16 sm:space-y-20 md:border-l lg:border-x border-white/5 px-0 md:pl-12 lg:px-24 order-1 md:order-2 lg:order-2 md:col-span-1 lg:col-span-1">
                <div className="space-y-8">
                  ...
                  <div className="space-y-5 sm:space-y-6 font-serif text-base sm:text-lg md:text-xl leading-relaxed text-foreground/80 max-w-2xl">
                    <p>
